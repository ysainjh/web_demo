...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [["fullscreen","source","undo","redo","insertunorderedlist","insertorderedlist","unlink","link","cleardoc","selectall","print","searchreplace","preview","help","|","gmap","pagebreak","insertimage","scrawl","insertvideo","attachment","insertframe","wordimage","map","horizontal","anchor","spechars","blockquote","insertcode","template","background","bold","italic","underline","strikethrough","forecolor","backcolor","superscript","subscript","justifyleft","justifycenter","justifyright","justifyjustify","formatmatch","removeformat","indent","directionalityrtl","directionalityltr","customstyle","autotypeset","paragraph","rowspacingbottom","rowspacingtop","lineheight","fontfamily","fontsize","imagenone","imageleft","imageright","imagecenter","inserttable","deletetable","mergeright","mergedown","splittorows","splittocols","splittocells","mergecells","insertcol","insertrow","deletecol","deleterow","insertparagraphbeforetable"],[],[],[],[]]
